...
class Template_Compiler_
{
    ...
    public $postfilter;
    public $postfilters;
    public $postfilters_flip;
    public $prefilter;
    public $prefilters;
    public $prefilters_flip;
    public $quoted_str;
    public $rsv_words;
    public $safe_mode;
    public $safe_mode_functions;
    public $skin;
    public $statement;
    public $template_dir;
    public $tpl_path;
